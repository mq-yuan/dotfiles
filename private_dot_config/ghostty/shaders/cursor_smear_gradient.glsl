/*
 * Shader: Smear Gradient
 * Author: KroneCorylus (https://github.com/KroneCorylus)
 * Repository: https://github.com/KroneCorylus/ghostty-shader-playground
 * License: MIT (https://opensource.org/licenses/MIT)
 *
 * Description: A shader that creates a smear gradient effect following the cursor.
 */
